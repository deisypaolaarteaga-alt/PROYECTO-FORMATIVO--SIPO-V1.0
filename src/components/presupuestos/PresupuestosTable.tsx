        ...
        {paginaItems.map((r) => {
          ...
          return (
            ...
            >
              ...
              {/* Arrow Navigation */}
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#F3F4F6] text-[#9CA3AF] group-hover:bg-[#D95510] group-hover:text-white transition-all duration-150 shrink-0">
