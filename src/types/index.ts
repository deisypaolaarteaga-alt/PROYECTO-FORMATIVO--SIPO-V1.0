...
export const ESTADO_PRESUPUESTO_CONFIG: Record<EstadoPresupuesto, {
  ...
  enviado_a_cliente:    { label: 'Enviado al cliente',   badge: 'bg-info-50 text-info-600',    dot: 'bg-[#1C4A72]' },
  visto_por_cliente:    { label: 'Visto por cliente',    badge: 'bg-info-50 text-info-600',    dot: 'bg-[#1C4A72]' },
