-- SIPO Migration: Fix Catalogo APU Prices (Colombia 2026) - REFINED
...
UPDATE catalogo_apu_items SET precio_unitario = 36750 WHERE tipo = 'material' AND (nombre ILIKE '%Cemento%gris%' OR nombre ILIKE '%Cemento%Argos%' OR nombre ILIKE '%Cemento%Cemex%');
-- Arena río (55.000 * 1.05 = 57.750)
UPDATE catalogo_apu_items SET precio_unitario = 57750 WHERE tipo = 'material' AND (nombre ILIKE '%Arena%río%' OR nombre ILIKE '%Arena%lavada%' OR nombre ILIKE '%Arena%de%río%');
-- Grava (65.000 * 1.05 = 68.250)
UPDATE catalogo_apu_items SET precio_unitario = 68250 WHERE tipo = 'material' AND (nombre ILIKE '%Grava%triturada%' OR nombre ILIKE '%Triturado%' OR nombre ILIKE '%Grava%3/4%');
-- Arena peña (48.000 * 1.05 = 50.400)
UPDATE catalogo_apu_items SET precio_unitario = 50400 WHERE tipo = 'material' AND nombre ILIKE '%Arena%peña%';
-- Bloques y Ladrillos
...
-- Acero refuerzo (180 kg/día) -> MO: 1268 (Usando Fierrero 140.000 + Ayudante 88.173)
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
...
-- Piso cerámica (12 m2/día) -> MO: 18181 (Usando Instalador 130.000 + Ayudante 88.173), EQ: 3750
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
...
-- Enchape muro cerámica (8 m2/día) -> MO: 27272, EQ: 5625
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
...
-- Punto hidráulico (4 pto/día) -> MO: 55043 (Plomero 132.000 + Ayudante 88.173)
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
...
-- Punto eléctrico (5 pto/día) -> MO: 44635 (Electricista 135.000 + Ayudante 88.173)
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
...
-- Estuco y pintura (25 m2/día) -> MO: 8527 (Pintor 125.000 + Ayudante 88.173), EQ: 600
UPDATE catalogo_apu_items cai
SET precio_unitario = CASE 
